...
public class HelpMenuView {
    ...
    private void helpItemMessage(String which) {
        switch (which) {
            case "1":
                which = "Your goal, as steward of the City of Aaron, is\n"
            ...
            case "2":
                which = "The City of Aaron is a lovely Nephite land with fields\n"
                        + "and villages, rivers and wild lands, stretching from\n"
                        + "the center of rule to the border of Lamanite land.\n\n";
                break;

            case "3":
                which = "View the Map at the start of any new or saved game\n"
                        + "or at any time from Game Menu.\n\n";
                break;

            case "4":
                which = "Move to a new location at the start of any new or saved game\n"
                        + "or at any time from Game Menu.\n\n";
                break;

            case "5":
                which = "You may view the Storehouse at the start of any new or saved game\n"
